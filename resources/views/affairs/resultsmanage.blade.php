...
<div class="container">
	<div class="row">
	  <div class="col-lm-12">
	    ...
	    <form class="form-horizontal" action="{{url('/student/postresult/'.$student->id)}}" method="post">
	            ...
	            @if($result !== null)
		            <td>
		            	<select name="type">
		            		...
		            		<option @if($result->type == 'Final') selected @endif value="Final">Final</option>
		            		<option @if($result->type == 'SemiFinal') selected @endif value="SemiFinal">SemiFinal</option>
		            	</select>
		            </td>
